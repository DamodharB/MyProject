...
To get familiar with the dataset, we find the first rows of "edx" set as below.
...
A summary of the set confirms that there are no missing values.
...
The total of unique movies and users in the edx set is about 70.000 unique users and about 10.700 different movies:
